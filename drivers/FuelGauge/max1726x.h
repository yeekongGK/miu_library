 ...
 *
 * Description:
 *   This file defines the public interface for the MAX1726x fuel gauge driver.
 *   It includes definitions for all device registers, data structures for
 *   configuration (EZ, short INI, full INI), and function prototypes for
 *   interacting with the device. This allows higher-level modules to
 *   configure the battery model, read status, and manage learned parameters.
 *
 * Notes:
 *   - This header file appears to be based on a reference implementation from
 *     Maxim Integrated.
 *
 * To Do:
 *   - -
