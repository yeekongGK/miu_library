...
typedef struct
{
  NFCTAG_Status_t       (*Init)( void );
  NFCTAG_Status_t       (*ReadID)( uint8_t * const );
  NFCTAG_Status_t       (*IsReady)( const uint32_t );
  NFCTAG_Status_t       (*GetITStatus)( uint16_t * const );
  NFCTAG_Status_t       (*ConfigIT)( const uint16_t );
  NFCTAG_Status_t       (*ReadData)( uint8_t * const, const uint16_t, const uint16_t );
  NFCTAG_Status_t       (*WriteData)( const uint8_t * const, const uint16_t, const uint16_t );
  NFCTAG_Status_t       (*ReadRegister)( uint8_t * const, const uint16_t, const uint16_t );
  NFCTAG_Status_t       (*WriteRegister)( const uint8_t * const, const uint16_t, const uint16_t );
  void                       *pData;
} NFCTAG_Drv_t;
...
typedef struct
{
//  NFCTAG_Status_t (*ReadICRev)( uint8_t * const );
//  NFCTAG_Status_t (*WriteITPulse)( const ST25DV_PULSE_DURATION );
//  NFCTAG_Status_t (*ReadITPulse)( ST25DV_PULSE_DURATION * const );
//  NFCTAG_Status_t (*ReadDataCurrentAddr)( uint8_t * const, const uint16_t );
//  NFCTAG_Status_t (*ReadUID)( ST25DV_UID * const );
//  NFCTAG_Status_t (*ReadDSFID)( uint8_t * const );
//  NFCTAG_Status_t (*ReadDsfidRFProtection)( ST25DV_LOCK_STATUS * const );
//  NFCTAG_Status_t (*ReadAFI)( uint8_t * const );
//  NFCTAG_Status_t (*ReadAfiRFProtection)( ST25DV_LOCK_STATUS * const );
//  NFCTAG_Status_t (*ReadI2CProtectZone)( ST25DV_I2C_PROT_ZONE * const );
//  NFCTAG_Status_t (*WriteI2CProtectZonex)( const ST25DV_PROTECTION_ZONE, const ST25DV_PROTECTION_CONF );
//  NFCTAG_Status_t (*ReadLockCCFile)( ST25DV_LOCK_CCFILE * const );
//  NFCTAG_Status_t (*WriteLockCCFile)( const ST25DV_CCFILE_BLOCK, const ST25DV_LOCK_STATUS );
//  NFCTAG_Status_t (*ReadLockCFG)( ST25DV_LOCK_STATUS * const );
//  NFCTAG_Status_t (*WriteLockCFG)( const ST25DV_LOCK_STATUS );
  NFCTAG_Status_t (*PresentI2CPassword)( const ST25DV_PASSWD );
  NFCTAG_Status_t (*WriteI2CPassword)( const ST25DV_PASSWD );
//  NFCTAG_Status_t (*ReadRFZxSS)( const ST25DV_PROTECTION_ZONE, ST25DV_RF_PROT_ZONE * const );
//  NFCTAG_Status_t (*WriteRFZxSS)( const ST25DV_PROTECTION_ZONE, const ST25DV_RF_PROT_ZONE );
//  NFCTAG_Status_t (*ReadEndZonex)( const ST25DV_END_ZONE, uint8_t * const );
//  NFCTAG_Status_t (*WriteEndZonex)( const ST25DV_END_ZONE, const uint8_t );
//  NFCTAG_Status_t (*InitEndZone)( void );
//  NFCTAG_Status_t (*CreateUserZone)( uint16_t, uint16_t, uint16_t, uint16_t );
  NFCTAG_Status_t (*ReadMemSize)( ST25DV_MEM_SIZE * const );
  NFCTAG_Status_t (*ReadEHMode)( ST25DV_EH_MODE_STATUS * const );
  NFCTAG_Status_t (*WriteEHMode)( const ST25DV_EH_MODE_STATUS );
//  NFCTAG_Status_t (*ReadRFMngt)( ST25DV_RF_MNGT * const );
  NFCTAG_Status_t (*WriteRFMngt)( const uint8_t );
//  NFCTAG_Status_t (*GetRFDisable)( ST25DV_EN_STATUS * const );
//  NFCTAG_Status_t (*SetRFDisable)( void );
//  NFCTAG_Status_t (*ResetRFDisable)( void );
//  NFCTAG_Status_t (*GetRFSleep)( ST25DV_EN_STATUS * const );
//  NFCTAG_Status_t (*SetRFSleep)( void );
//  NFCTAG_Status_t (*ResetRFSleep)( void );
  NFCTAG_Status_t (*ReadMBMode)( ST25DV_EN_STATUS * const );
  NFCTAG_Status_t (*WriteMBMode)( const ST25DV_EN_STATUS );
//  NFCTAG_Status_t (*ReadMBWDG)( uint8_t * const );
  NFCTAG_Status_t (*WriteMBWDG)( const uint8_t );
  NFCTAG_Status_t (*ReadMailboxData)( uint8_t * const, const uint16_t, const uint16_t );
  NFCTAG_Status_t (*WriteMailboxData)( const uint8_t * const, const uint16_t );
//  NFCTAG_Status_t (*ReadMailboxRegister)( uint8_t * const, const uint16_t, const uint16_t );
//  NFCTAG_Status_t (*WriteMailboxRegister)( const uint8_t * const, const uint16_t, const uint16_t );
  NFCTAG_Status_t (*ReadI2CSecuritySession_Dyn)( ST25DV_I2CSSO_STATUS * const );
  NFCTAG_Status_t (*ReadITSTStatus_Dyn)( uint8_t * const );
//  NFCTAG_Status_t (*ReadGPO_Dyn)( uint8_t * );
//  NFCTAG_Status_t (*GetGPO_en_Dyn)( ST25DV_EN_STATUS * const );
//  NFCTAG_Status_t (*SetGPO_en_Dyn)( void );
//  NFCTAG_Status_t (*ResetGPO_en_Dyn)( void );
//  NFCTAG_Status_t (*ReadEHCtrl_Dyn)( ST25DV_EH_CTRL * const );
//  NFCTAG_Status_t (*GetEHENMode_Dyn)( ST25DV_EN_STATUS * const );
//  NFCTAG_Status_t (*SetEHENMode_Dyn)( void );
  NFCTAG_Status_t (*ResetEHENMode_Dyn)( void );
//  NFCTAG_Status_t (*GetEHON_Dyn)( ST25DV_EN_STATUS * const );
  NFCTAG_Status_t (*GetRFField_Dyn)( ST25DV_FIELD_STATUS * const );
//  NFCTAG_Status_t (*GetVCC_Dyn)( ST25DV_VCC_STATUS * const );
//  NFCTAG_Status_t (*ReadRFMngt_Dyn)( ST25DV_RF_MNGT * const );
//  NFCTAG_Status_t (*WriteRFMngt_Dyn)( const uint8_t );
//  NFCTAG_Status_t (*GetRFDisable_Dyn)( ST25DV_EN_STATUS * const );
//  NFCTAG_Status_t (*SetRFDisable_Dyn)( void );
//  NFCTAG_Status_t (*ResetRFDisable_Dyn)( void );
//  NFCTAG_Status_t (*GetRFSleep_Dyn)( ST25DV_EN_STATUS * const );
//  NFCTAG_Status_t (*SetRFSleep_Dyn)( void );
//  NFCTAG_Status_t (*ResetRFSleep_Dyn)( void );
  NFCTAG_Status_t (*ReadMBctrl_Dyn)( ST25DV_MB_CTRL_DYN_STATUS * const );
//  NFCTAG_Status_t (*GetMBEN_Dyn)( ST25DV_EN_STATUS * const );
  NFCTAG_Status_t (*SetMBEN_Dyn)( void );
  NFCTAG_Status_t (*ResetMBEN_Dyn)( void );
  NFCTAG_Status_t (*ReadMBLength_Dyn)( uint8_t * const );
} NFCTAG_ExtDrv_t;
#endif
...
extern NFCTAG_Drv_t St25Dv_i2c_Drv;
extern NFCTAG_ExtDrv_t St25Dv_i2c_ExtDrv;

/* Exported macro ------------------------------------------------------------*/
/* Imported functions ------------------------------------------------------- */
extern NFCTAG_Status_t ST25DV_IO_Init( void );
extern NFCTAG_Status_t ST25DV_IO_MemWrite( const uint8_t * const pData, const uint8_t DevAddr, const uint16_t TarAddr, const uint16_t Size );
extern NFCTAG_Status_t ST25DV_IO_Write( const uint8_t * const pData, const uint8_t DevAddr, const uint16_t Size );
extern NFCTAG_Status_t ST25DV_IO_MemRead( uint8_t * const pData, const uint8_t DevAddr, const uint16_t TarAddr, const uint16_t Size );
extern NFCTAG_Status_t ST25DV_IO_Read( uint8_t * const pData, const uint8_t DevAddr, const uint16_t Size );
extern uint8_t ST25DV_IO_IsNacked( void );
extern NFCTAG_Status_t ST25DV_IO_IsDeviceReady( const uint8_t DevAddr, const uint32_t Trials );
