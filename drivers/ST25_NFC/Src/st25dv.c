...
NFCTAG_Status_t ST25DV_i2c_ReadICRev( uint8_t * const pICRev );
...
NFCTAG_Status_t ST25DV_i2c_ReadITPulse( ST25DV_PULSE_DURATION * const pITtime );
NFCTAG_Status_t ST25DV_i2c_WriteITPulse( const ST25DV_PULSE_DURATION ITtime );
...
NFCTAG_Status_t ST25DV_i2c_ReadDataCurrentAddr( uint8_t * const pData, const uint16_t NbByte );
...
NFCTAG_Status_t ST25DV_i2c_ReadUID( ST25DV_UID * const pUid );
NFCTAG_Status_t ST25DV_i2c_ReadDSFID( uint8_t * const pDsfid );
NFCTAG_Status_t ST25DV_i2c_ReadDsfidRFProtection( ST25DV_LOCK_STATUS * const pLockDsfid );
NFCTAG_Status_t ST25DV_i2c_ReadAFI( uint8_t * const pAfi );
NFCTAG_Status_t ST25DV_i2c_ReadAfiRFProtection( ST25DV_LOCK_STATUS * const pLockAfi );
NFCTAG_Status_t ST25DV_i2c_ReadI2CProtectZone( ST25DV_I2C_PROT_ZONE * const pProtZone );
NFCTAG_Status_t ST25DV_i2c_WriteI2CProtectZonex( const ST25DV_PROTECTION_ZONE Zone, const ST25DV_PROTECTION_CONF ReadWriteProtection );
NFCTAG_Status_t ST25DV_i2c_ReadLockCCFile( ST25DV_LOCK_CCFILE * const pLockCCFile );
NFCTAG_Status_t ST25DV_i2c_WriteLockCCFile( const ST25DV_CCFILE_BLOCK NbBlockCCFile, const ST25DV_LOCK_STATUS LockCCFile );
NFCTAG_Status_t ST25DV_i2c_ReadLockCFG( ST25DV_LOCK_STATUS * const pLockCfg );
NFCTAG_Status_t ST25DV_i2c_WriteLockCFG( const ST25DV_LOCK_STATUS LockCfg );
...
NFCTAG_Status_t ST25DV_i2c_ReadRFZxSS( const ST25DV_PROTECTION_ZONE Zone, ST25DV_RF_PROT_ZONE * const pRfprotZone );
NFCTAG_Status_t ST25DV_i2c_WriteRFZxSS( const ST25DV_PROTECTION_ZONE Zone, const ST25DV_RF_PROT_ZONE RfProtZone );
NFCTAG_Status_t ST25DV_i2c_ReadEndZonex( const ST25DV_END_ZONE EndZone, uint8_t * const pEndZ );
NFCTAG_Status_t ST25DV_i2c_WriteEndZonex( const ST25DV_END_ZONE EndZone, const uint8_t EndZ );
NFCTAG_Status_t ST25DV_i2c_InitEndZone( void );
NFCTAG_Status_t ST25DV_i2c_CreateUserZone( uint16_t Zone1Length, uint16_t Zone2Length, uint16_t Zone3Length, uint16_t Zone4Length );
...
NFCTAG_Status_t ST25DV_i2c_ReadRFMngt( ST25DV_RF_MNGT * const pRF_Mngt );
NFCTAG_Status_t ST25DV_i2c_WriteRFMngt( const uint8_t Rfmngt );
NFCTAG_Status_t ST25DV_i2c_GetRFDisable( ST25DV_EN_STATUS * const pRFDisable );
NFCTAG_Status_t ST25DV_i2c_SetRFDisable( void );
NFCTAG_Status_t ST25DV_i2c_ResetRFDisable( void );
NFCTAG_Status_t ST25DV_i2c_GetRFSleep( ST25DV_EN_STATUS * const pRFSleep );
NFCTAG_Status_t ST25DV_i2c_SetRFSleep( void );
NFCTAG_Status_t ST25DV_i2c_ResetRFSleep( void );
...
NFCTAG_Status_t ST25DV_i2c_ReadMBWDG( uint8_t * const pWdgDelay );
NFCTAG_Status_t ST25DV_i2c_WriteMBWDG( const uint8_t WdgDelay );
NFCTAG_Status_t ST25DV_i2c_ReadMailboxData( uint8_t * const pData, const uint16_t TarAddr, const uint16_t NbByte );
...
NFCTAG_Status_t ST25DV_i2c_ReadGPO_Dyn( uint8_t *GPOConfig );
NFCTAG_Status_t ST25DV_i2c_GetGPO_en_Dyn( ST25DV_EN_STATUS * const pGPO_en );
NFCTAG_Status_t ST25DV_i2c_SetGPO_en_Dyn( void );
NFCTAG_Status_t ST25DV_i2c_ResetGPO_en_Dyn( void );
NFCTAG_Status_t ST25DV_i2c_ReadEHCtrl_Dyn( ST25DV_EH_CTRL * const pEH_CTRL );
NFCTAG_Status_t ST25DV_i2c_GetEHENMode_Dyn( ST25DV_EN_STATUS * const pEH_Val );
NFCTAG_Status_t ST25DV_i2c_SetEHENMode_Dyn( void );
NFCTAG_Status_t ST25DV_i2c_ResetEHENMode_Dyn( void );
NFCTAG_Status_t ST25DV_i2c_GetEHON_Dyn( ST25DV_EN_STATUS * const pEHON );
NFCTAG_Status_t ST25DV_i2c_GetRFField_Dyn( ST25DV_FIELD_STATUS * const pRF_Field );
NFCTAG_Status_t ST25DV_i2c_GetVCC_Dyn( ST25DV_VCC_STATUS * const pVCC );
NFCTAG_Status_t ST25DV_i2c_ReadRFMngt_Dyn( ST25DV_RF_MNGT * const pRF_Mngt );
NFCTAG_Status_t ST25DV_i2c_WriteRFMngt_Dyn( const uint8_t RF_Mngt );
NFCTAG_Status_t ST25DV_i2c_GetRFDisable_Dyn( ST25DV_EN_STATUS * const pRFDisable );
NFCTAG_Status_t ST25DV_i2c_SetRFDisable_Dyn( void );
NFCTAG_Status_t ST25DV_i2c_ResetRFDisable_Dyn( void );
NFCTAG_Status_t ST25DV_i2c_GetRFSleep_Dyn( ST25DV_EN_STATUS * const pRFSleep );
NFCTAG_Status_t ST25DV_i2c_SetRFSleep_Dyn( void );
NFCTAG_Status_t ST25DV_i2c_ResetRFSleep_Dyn( void );
NFCTAG_Status_t ST25DV_i2c_ReadMBCtrl_Dyn( ST25DV_MB_CTRL_DYN_STATUS * const pCtrlStatus );
NFCTAG_Status_t ST25DV_i2c_GetMBEN_Dyn( ST25DV_EN_STATUS * const pMBEN );
...
/**
  ...
  */
NFCTAG_ExtDrv_t St25Dv_i2c_ExtDrv =
{
//  0,//ST25DV_i2c_ReadICRev,
//  0,//ST25DV_i2c_WriteITPulse,
//  0,//ST25DV_i2c_ReadITPulse,
//  0,//ST25DV_i2c_ReadDataCurrentAddr,
//  0,//ST25DV_i2c_ReadUID,
//  0,//ST25DV_i2c_ReadDSFID,
//  0,//ST25DV_i2c_ReadDsfidRFProtection,
//  0,//ST25DV_i2c_ReadAFI,
//  0,//ST25DV_i2c_ReadAfiRFProtection,
//  0,//ST25DV_i2c_ReadI2CProtectZone,
//  0,//ST25DV_i2c_WriteI2CProtectZonex,
//  0,//ST25DV_i2c_ReadLockCCFile,
//  0,//ST25DV_i2c_WriteLockCCFile,
//  0,//ST25DV_i2c_ReadLockCFG,
//  0,//ST25DV_i2c_WriteLockCFG,
  ST25DV_i2c_PresentI2CPassword,
  ST25DV_i2c_WriteI2CPassword,
//  0,//ST25DV_i2c_ReadRFZxSS,
//  0,//ST25DV_i2c_WriteRFZxSS,
//  0,//ST25DV_i2c_ReadEndZonex,
//  0,//ST25DV_i2c_WriteEndZonex,
//  0,//ST25DV_i2c_InitEndZone,
//  0,//ST25DV_i2c_CreateUserZone,
  ST25DV_i2c_ReadMemSize,
  ST25DV_i2c_ReadEHMode,
  ST25DV_i2c_WriteEHMode,
//  0,//ST25DV_i2c_ReadRFMngt,
  ST25DV_i2c_WriteRFMngt,
//  0,//ST25DV_i2c_GetRFDisable,
//  0,//ST25DV_i2c_SetRFDisable,
//  0,//ST25DV_i2c_ResetRFDisable,
//  0,//ST25DV_i2c_GetRFSleep,
//  0,//ST25DV_i2c_SetRFSleep,
//  0,//ST25DV_i2c_ResetRFSleep,
  ST25DV_i2c_ReadMBMode,
  ST25DV_i2c_WriteMBMode,
//  0,//ST25DV_i2c_ReadMBWDG,
  ST25DV_i2c_WriteMBWDG,
  ST25DV_i2c_ReadMailboxData,
  ST25DV_i2c_WriteMailboxData,
//  0,//ST25DV_i2c_ReadMailboxRegister,
//  0,//ST25DV_i2c_WriteMailboxRegister,
  ST25DV_i2c_ReadI2CSecuritySession_Dyn,
  ST25DV_i2c_ReadITSTStatus_Dyn,
//  0,//ST25DV_i2c_ReadGPO_Dyn,
//  0,//ST25DV_i2c_GetGPO_en_Dyn,
//  0,//ST25DV_i2c_SetGPO_en_Dyn,
//  0,//ST25DV_i2c_ResetGPO_en_Dyn,
//  0,//ST25DV_i2c_ReadEHCtrl_Dyn,
//  0,//ST25DV_i2c_GetEHENMode_Dyn,
//  0,//ST25DV_i2c_SetEHENMode_Dyn,
  ST25DV_i2c_ResetEHENMode_Dyn,
//  0,//ST25DV_i2c_GetEHON_Dyn,
  ST25DV_i2c_GetRFField_Dyn,
//  0,//ST25DV_i2c_GetVCC_Dyn,
//  0,//ST25DV_i2c_ReadRFMngt_Dyn,
//  0,//ST25DV_i2c_WriteRFMngt_Dyn,
//  0,//ST25DV_i2c_GetRFDisable_Dyn,
//  0,//ST25DV_i2c_SetRFDisable_Dyn,
//  0,//ST25DV_i2c_ResetRFDisable_Dyn,
//  0,//ST25DV_i2c_GetRFSleep_Dyn,
//  0,//ST25DV_i2c_SetRFSleep_Dyn,
//  0,//ST25DV_i2c_ResetRFSleep_Dyn,
  ST25DV_i2c_ReadMBCtrl_Dyn,
//  0,//ST25DV_i2c_GetMBEN_Dyn,
